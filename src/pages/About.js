          ...
          <div className="mv-grid">
            <div className="glass-card mv-card">
              ...
              <p>
                ...
                transform their online presence and drive measurable growth. We
                build technology that creates real business impact.
              </p>
            </div>
            <div className="glass-card mv-card">
              <div className="mv-icon">🚀</div>
              <h2>Our Vision</h2>
              <p>
                To become the leading digital innovation partner for businesses
                seeking excellence in web development, delivering world-class
        ...
        <div className="container">
          ...
          <div className="story-content">
            <p>
              ...
              that many businesses struggle with outdated digital presence that
              fails to represent their true value.
            </p>
            <p>
              Our journey began with a commitment to excellence in web
              development and digital solutions. We combine technical expertise
              with strategic thinking to deliver solutions that don't just look
          ...
          <div className="team-grid">
            <div className="glass-card team-card">
              ...
              <p className="team-bio">
                ...
                built with cutting-edge technology and exceptional code quality.
              </p>
            ...
            <div className="glass-card team-card">
              ...
              <p className="team-bio">
                ...
                client success, ensuring PixelNest delivers exceptional value
                and drives measurable results for every client.
              </p>
              <div className="expertise-tags">
        ...
        <div className="container">
          ...
          <div className="values-grid">
            ...
            <div className="value-card">
              ...
              <p>
                Every decision focused on delivering measurable business impact
              </p>
            </div>
            <div className="value-card">
              <h3>⚡ Excellence</h3>
            ...
            <div className="value-card">
              <h3>🤝 Partnership</h3>
              <p>Building long-term relationships based on trust and success</p>
            </div>
          </div>
        </div>
      </section>
